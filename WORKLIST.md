...
**Current holder:** `onstack-3a since 2026-09-16T18:19Z (expected ~25m, cargo check probe)`
...
| **[Activation cost not paid, issue #782]** Thought Lash — the "Exile the top card of your library:" activated ability is reported to resolve without paying its exile cost. Cumulative-upkeep half is #581. | old-school-1993-95 | PR open | 36e2b430 | 2026-09-16 | `fix/thought-lash-782` | [phase-rs/phase#8911](https://github.com/phase-rs/phase/pull/8911) @ `ff24db87f` (3 maintainer findings addressed: CR 118.11 revert, CostPaidObject binding + Devourer coverage, resumed-path delivery recording; redirect regression disclosed as outstanding) |
