...
|---|---|---|---|---|---|---|
| **[Delayed trigger target binding, issue #6902]** Sneak Attack — two activations in one turn create two next-end-step sacrifice triggers, but the second carries `targets: []` and sacrifices nothing, stranding one creature (reproduced on v0.81.2, 2026-09-12). No commit or test cites the issue. Reproducing on current upstream as a runtime test before touching code; upstream #8881 (delayed trigger ParentTargetSlot binding) is adjacent and is checked first. | old-school-1993-95 | in-progress | void-mirror-603-4 | 2026-09-15 | fix/sneak-attack-6902 | — |
