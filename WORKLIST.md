...
|---|---|---|---|---|---|---|
| **[Mass mutual control exchange, issue #4731]** Reins of Power — "You and that opponent each gain control of all creatures the other controls until end of turn" reported as handing the caster every creature on the board. July triage: parsed as a single `GainControlAll` (controller filter null, new controller always the caster) with no reverse direction. No commit or test cites the issue; checking whether later control-change work (#8332 exchangeable control, #8808) added a mutual-exchange effect before reproducing. | old-school-1993-95 | in-progress | void-mirror-603-4 | 2026-09-15 | fix/reins-of-power-4731 | — |
