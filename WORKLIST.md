...
|---|---|---|---|---|---|---|
| **[Delayed-trigger turn gate, issue #4231]** Final Fortune — "At the beginning of that turn's end step, you lose the game" lowers with `TurnGate::None`, so the loss fires at the casting turn's own end step instead of the granted extra turn's. | old-school-1993-95 | in-progress | 36e2b430 | 2026-09-15 | `fix/final-fortune-4231` | — |
