...
use engine::types::interaction::{
    ...
    InteractionAttachmentFanChild, InteractionAttachmentView, InteractionAttachmentViewCard,
    ...
    InteractionShortcutPreview, InteractionShortcutPreviewEntry, InteractionShortcutPreviewFamily,
...
const HEADER: &str = "// @generated by `cargo run -p phase-engine --features interaction-bindings --bin interaction-bindings -- --write`.\n// Do not edit by hand.\n\n";
...
fn expected_bindings() -> String {
    ...
    push_declarations!(
        ...
        InteractionManaComparator,
        InteractionManaAbilityActivationScope,
        InteractionManaZoneSpendPolarity,
        InteractionManaSpecialAction,
